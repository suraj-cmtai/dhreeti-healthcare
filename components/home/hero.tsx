...
export default function Hero() {
    return (
    <section className="relative min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-50 via-white to-teal-50 overflow-hidden">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8">
            ...
            {/* <Button
              size="lg"
              variant="outline"
              className="border-2 hover:text-teal-700 border-teal-400 text-teal-700 hover:bg-teal-50 text-lg font-semibold shadow-lg hover:shadow-xl transition-all bg-white/80 backdrop-blur-sm h-auto"
            >
      ...
      <motion.div
        ...
        className="mt-16 max-w-4xl mx-auto z-10"
      >
        {/* 16:9 Aspect Ratio Container */}
        <div className="relative w-full aspect-video rounded-xl shadow-card-light dark:shadow-card overflow-hidden glass-light dark:glass-dark border border-primary/10 dark:border-primary/20">
          <VideoWithFallback />
        </div>
      </motion.div>
    </section>
    ...
    <div className="relative w-full h-full aspect-video">
      {!videoError ? (
        <>
          ...
          >
            <span className="bg-white/80 dark:bg-black/60 rounded-full p-4 shadow-lg">
              {isPlaying ? (
                <Pause className="w-16 h-16 text-primary group-hover:scale-110 transition-transform" />
              ) : (
