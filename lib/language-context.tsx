...
const hiTranslations = {
  ...
  about: {
    title: "धृति क्लीनिक के बारे में",
    subtitle: "देखभाल और उत्कृष्टता की विरासत",
    description: "2022 में स्थापित, धृति क्लीनिक समुदाय को असाधारण स्वास्थ्य सेवाएं प्रदान करने में अग्रणी रहा है। हमारी अत्याधुनिक सुविधा नवीनतम चिकित्सा प्रौद्योगिकी से सुसज्जित है और अत्यधिक योग्य स्वास्थ्य देखभाल पेशेवरों द्वारा संचालित है।",
    mission: "हमारा मिशन",
  ...
  whyChoose: {
    ...
    description: "धृति क्लीनिक में, हम अपने मरीजों को उच्चतम गुणवत्ता की देखभाल प्रदान करने के लिए प्रतिबद्ध हैं। यहां बताया गया है कि आपको अपनी स्वास्थ्य देखभाल जरूरतों के लिए हमें क्यों चुनना चाहिए:",
  ...
  testimonials: {
    ...
    description: "सिर्फ हमारी बात मत मानिए। धृति क्लीनिक में अपने अनुभवों के बारे में हमारे संतुष्ट मरीजों से सुनिए।",
    testimonial1Name: "राजेश कुमार",
    testimonial1Text: "मैं अब एक साल से अधिक समय से धृति क्लीनिक का मरीज हूं, और मुझे मिली देखभाल से मैं बेहद संतुष्ट हूं। डॉक्टर जानकार और देखभाल करने वाले हैं, और स्टाफ हमेशा मित्रवत और सहायक होता है।",
    testimonial2Name: "प्रिया शर्मा",
    testimonial2Text: "वर्षों तक अपने स्वास्थ्य संबंधी समस्याओं से जूझने के बाद, मुझे आखिरकार धृति क्लीनिक में राहत मिली। डॉक्टरों ने मेरी चिंताओं को समझने के लिए समय निकाला और मेरे लिए एक उपचार योजना विकसित की जो मेरे लिए काम करती थी। मैं उनकी विशेषज्ञता और करुणा के लिए आभारी हूं।",
    testimonial3Name: "अमित पटेल",
    testimonial3Text: "धृति क्लीनिक में मुझे मिली देखभाल और ध्यान का स्तर असाधारण था। जैसे ही मैं अंदर गया, मुझे एक मरीज के रूप में स्वागत और सम्मान महसूस हुआ। डॉक्टरों ने सब कुछ स्पष्ट रूप से समझाया और मेरी सभी चिंताओं का समाधान किया।"
  },
  diseases: {
    diabetes: {
      name: "मधुमेह",
  ...
  aboutPage: {
    pageTitle: "धृति क्लीनिक के बारे में",
    ...
    missionText: "धृति क्लीनिक में हमारा मिशन सरल है: विश्वसनीय स्वास्थ्य सेवा को सुलभ और किफायती दोनों बनाना। हम रोगी देखभाल और विश्वास पर ध्यान केंद्रित करके आवश्यक चिकित्सा सेवाएं प्रदान करते हैं, हमारे तीन-स्तरीय शहर में हमारे समुदाय को वित्तीय बोझ के बिना स्वस्थ जीवन जीने के लिए सशक्त बनाते हैं।",
  ...
  footer: {
    ...
    email: "dhreeti.india@gmail.com",
    copyright: "धृति क्लीनिक। सर्वाधिकार सुरक्षित।",
  ...
  privacy: {
    ...
    intro: {
      ...
      description: "धृति क्लीनिक एंड रिसर्च प्राइवेट लिमिटेड में, हम आपकी गोपनीयता की रक्षा और आपकी व्यक्तिगत और स्वास्थ्य जानकारी की सुरक्षा सुनिश्चित करने के लिए प्रतिबद्ध हैं। यह गोपनीयता नीति बताती है कि जब आप हमारी स्वास्थ्य सेवाओं का उपयोग करते हैं तो हम आपकी जानकारी कैसे एकत्र, उपयोग, प्रकट और सुरक्षित करते हैं।"
    },
    sections: {
      information: {
  ...
  terms: {
    ...
    pageDescription: "हमारी स्वास्थ्य सेवाओं का उपयोग करने से पहले कृपया इन नियमों को ध्यान से पढ़ें। ये नियम धृति क्लीनिक के साथ आपके संबंध को नियंत्रित करते हैं।",
    intro: {
      title: {
  ...
  servicesPage: {
    ...
    pathology: {
      ...
      microbiology: {
        title: "क्लीनिकल माइक्रोबायोलॉजी",
